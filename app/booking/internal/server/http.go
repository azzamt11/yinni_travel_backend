...
func NewHTTPServer(c *conf.Server, authConf *conf.Auth, booking *service.BookingService, logger log.Logger) *http.Server {
	...
	v1.RegisterBookingHTTPServer(srv, booking)
	return srv
}
